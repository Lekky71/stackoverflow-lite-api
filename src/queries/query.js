...
module.exports = {
  ...
  find_user_by_id: `SELECT ${userReturn} FROM users WHERE user_id = $1 `,
  ...
  create_answers_table: `CREATE TABLE IF NOT EXISTS answers (answer_id TEXT PRIMARY KEY NOT NULL,
                         ...
                         content TEXT,
                         answerer_user_id TEXT REFERENCES users(user_id),
                         up_votes INTEGER,
                         down_votes INTEGER, 
                         created_at TIMESTAMP );`,
  create_comments_table: `CREATE TABLE IF NOT EXISTS comments (comment_id TEXT PRIMARY KEY NOT NULL,
                          ...
                          content TEXT,
                          poster_user_id TEXT REFERENCES users(user_id),
                          created_at TIMESTAMP );`,
};
